...
server.tool(
  "read_inbox",
  "Read your Ayo inbox — pings sent to you, with their work context. Reads the ACTIVE team only; `ayo team switch` changes it, and the CLI `ayo inbox` covers every team. (pings sent to you) with their work context. Surfacing " +
